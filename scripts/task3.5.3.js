...
let shoppingCart = [
  ...
  console.log("Alcohol products have 5% discount : " +  discountAmount( shoppingCart, 5, "alcohol") );


    
  
  // link from Luke https://github.com/EyeSee78/LTU-reboot-Digital-Coding/blob/main/module-3/task-3.5.3.html